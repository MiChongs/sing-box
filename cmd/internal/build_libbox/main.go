...
func init() {
	...
	sharedTags = append(sharedTags, "with_gvisor", "with_quic", "with_wireguard", "with_utls", "with_naive_outbound", "with_clash_api", "with_xhttp", "badlinkname", "tfogo_checklinkname0")
