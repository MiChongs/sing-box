...
func (c *gLazyConn) HandshakeContext(ctx context.Context) error {
	...
	endpoint.SetSockOpt(common.Ptr(tcpip.KeepaliveIdleOption(30 * time.Second)))
	endpoint.SetSockOpt(common.Ptr(tcpip.KeepaliveIntervalOption(30 * time.Second)))
...
func (c *gLazyConn) ReaderReplaceable() bool {
	return c.handshakeDone.Load() && c.handshakeErr == nil
}
